...
config.plugins.tmdb.lang = ConfigSelection(default=defaultLang, choices=languages)
...
def Plugins(**kwargs):
    pList = [PluginDescriptor(name="TMDb", description=_("TMDb search"), where=PluginDescriptor.WHERE_MOVIELIST, fnc=movielist, needsRestart=False),
